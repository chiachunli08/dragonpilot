...
from opendbc.car.volvo.values import CAR, PLATFORM, DBC, BUTTON_STATES, CarControllerParams as CCP
...
class CarState(CarStateBase):
  ...
  def get_can_parsers(CP):
    ...
    if CP.carFingerprint in PLATFORM.C1:
      cam_signals.append(("TrqLim", "FSM1", 0x80))
      cam_signals.append(("LKAAngleReq", "FSM1", 0x2000))
      cam_signals.append(("Checksum", "FSM1", 0x5f))
      cam_signals.append(("LKASteerDirection", "FSM1", 0x00))
      cam_signals.append(("SET_X_E3", "FSM1", 0xE3))
      cam_signals.append(("SET_X_B4", "FSM1", 0xB4))
      cam_signals.append(("SET_X_08", "FSM1", 0x08))
      cam_signals.append(("SET_X_02", "FSM1", 0x02))
      cam_signals.append(("SET_X_25", "FSM1", 0x25))
      cam_signals.append(("ACCStatusOnOff", "FSM0", 0x00))
      cam_signals.append(("ACCStatusActive", "FSM0", 0x00))
      cam_checks.append(('FSM0', 100))
      cam_checks.append(('FSM1', 50))

    elif CP.carFingerprint in PLATFORM.EUCD:
      cam_signals.append(("ACCStatus", "FSM0", 0))
      cam_signals.append(("TrqLim", "FSM2", 0x80))
      cam_signals.append(("LKAAngleReq", "FSM2", 0x2000))
      cam_signals.append(("Checksum", "FSM2", 0x5f))
      cam_signals.append(("LKASteerDirection", "FSM2", 0x00))
      cam_signals.append(("SET_X_22", "FSM2", 0x00))
      cam_signals.append(("SET_X_02", "FSM2", 0x00))
      cam_signals.append(("SET_X_10", "FSM2", 0x00))
      cam_signals.append(("SET_X_A4", "FSM2", 0x00))
      cam_checks.append(('FSM0', 100))
      cam_checks.append(('FSM2', 50))
